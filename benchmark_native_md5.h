...
namespace benchmark_reference
{
// Scalar native MD5 for exactly four input bytes packed little endian.
inline std::array<std::uint32_t, 4> md5_four_bytes(std::uint32_t message_word)
{
